...
def parse_args():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./checkpoints/', help='where to save the best model')#./checkpoints/./models/ ./test_single_class/models/
    parser.add_argument("--seed", type=int, default=42, help="seed")
    parser.add_argument('--gpu', type=int, default=None)
    parser.add_argument('--mode', type=str, default='train') # predict, train
    parser.add_argument('--rmbg', type=str, default=True) # remove background
    ...
    parser.add_argument('--source_split', type=float, nargs='+', default=[0.8, 0.1, 0.1])

    parser.add_argument('--num_folds', type=int, default=10)
    parser.add_argument('--visualize', type=bool, default=False)

    parser.add_argument("--opt_goal", type=str, default='ts', help="pick the best model based on this metric") # ts, accuracy, val_loss
