...
def parse_args():
    ...
    parser.add_argument('--adv_on', type=str, default='both', help='both, exp_2014, exp_2015')
    ...
    parser.add_argument("--early_stop_epoch", type=int, default=20, help="early stop epoch")
