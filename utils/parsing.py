...
def parse_args():
    ...
    parser.add_argument("--opt_goal", type=str, default='accuracy', help="pick the best model based on this metric")
    parser.add_argument("--lr", type=float, default=1e-3, help="learning rate")
    parser.add_argument('--dropout', type=float, default=0.4)
    parser.add_argument('--weight_decay', type=float, default=0.001)
    parser.add_argument("--epochs", type=int, default=100, help="number of epochs")
    parser.add_argument("--batch_size", type=int, default=4)
    parser.add_argument("--early_stop_epoch", type=int, default=100, help="early stop epoch")
    ...
    parser.add_argument('--adaptation', type=float, default=0.6, help="adaptation factor")
